...
if __name__ == '__main__':
    train_data = Vertebrae_Dataset('/DATA/data/hyguan/liuyuan_spine/data_all/patient_image_4', '/DB/rhome/bllai/PyTorchProjects/Vertebrae/dataset/train_path.csv', phase='train', balance=True)
    # test_data = Vertebrae_Dataset('/DATA/data/hyguan/liuyuan_spine/data_all/patient_image_4', '/DB/rhome/bllai/PyTorchProjects/Vertebrae/dataset/test_path.csv', phase='test')
    # print(train_data.dist())
    # print(test_data.dist())
    l = []
    train_dataloader = DataLoader(train_data, batch_size=32, shuffle=True, num_workers=4)
    for i, (img, lab, one_hot) in tqdm(enumerate(train_dataloader)):
        pass
