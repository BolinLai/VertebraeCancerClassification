...
if __name__ == '__main__':
    train_data = Vertebrae_Dataset('/DATA/data/hyguan/liuyuan_spine/data_all/patient_image_4', '/DB/rhome/bllai/PyTorchProjects/Vertebrae/train_path.csv', phase='train', balance=True)
